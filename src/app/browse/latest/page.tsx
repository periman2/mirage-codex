...
import { useLatestBooks } from '@/lib/queries'
...
export default function LatestReleasesPage() {
  const latestBooksQuery = useLatestBooks(24) // Load more books for the dedicated page

  const { data, isLoading, hasNextPage, fetchNextPage, isFetchingNextPage } = latestBooksQuery
        ...
        <section className="space-y-4">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-mirage-text-tertiary text-lg">
              Discover the newest books in the infinite collection
            </p>
          </div>
        </section>
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-mirage-text-tertiary">
                ...
                <p className="text-sm text-center max-w-md">
                  Check back later for new releases in the collection.
                </p>
              </div>
            ) : (
